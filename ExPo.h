...
void cout_value(point_list *pl)
{
	...
	//locks
	cout <<  right <<setw(5) << pl[5].point_dic->current_data << "\033[33m" << setw(1) << "|"<<"\033[0m";
	//tmp_tables
	cout <<  right << setw(4) << pl[6].point_dic->current_data << setw(1) << " ";
	cout << right << setw(4) << pl[7].point_dic->current_data << "\033[33m" << setw(2) << "|"<<"\033[0m";
	//innodb_buffer
	cout << right << setw(6) << pl[8].point_dic->current_data << setw(1) << " ";
	cout << right << setw(8) << pl[9].point_dic->current_data << "\033[33m" << setw(1) << "|"<<"\033[0m";
	//handler
	cout << right << setw(7) << pl[10].point_dic->current_data << setw(1) << " ";
	...
	cout << right << setw(7) << pl[15].point_dic->current_data << "\033[33m" << setw(1) << "|"<<"\033[0m";
	//innodb log
	cout << right << setw(3) << pl[16].point_dic->current_data << setw(1) << " ";
	cout << right << setw(3) << pl[17].point_dic->current_data << setw(1) << " ";
	cout << right << setw(3) << pl[18].point_dic->current_data << "\033[33m" << setw(1) << "|"<<"\033[0m";

	//thread
	cout << right << setw(4) << pl[19].point_dic->current_data << setw(1) << " ";
	cout << right << setw(3) << pl[20].point_dic->current_data << "\033[33m" << setw(1) << "|"<<"\033[0m";

	//cpu
	cout.setf(ios::fixed);
	cout.precision(0);
	cout << right << setw(3) << pl[21].point_dic->cpu_data << setw(1) << " ";
...
void print_head()
{
	...
	cout << "\033[31m" << setw(6) << " lock\033[32m|\033[0m" ;
	...
	//lock
	cout << right << "\033[32m" << setw(5) << head_name[5].name << setw(1) << "|";

	//tmp_table
	cout << right << "\033[32m" << setw(4) << head_name[6].name << setw(1) << " ";
	cout << right << "\033[32m" << setw(4) << head_name[7].name << setw(2) << "|";

	//buffer
	cout << right << "\033[32m" << setw(6) << head_name[8].name << setw(1) << " ";
	cout << right << "\033[32m" << setw(8) << head_name[9].name << setw(1) << "|";
	...
	//innodb_log
	cout << right << "\033[32m" << setw(3) << head_name[16].name << setw(1) << " ";
	cout << right << "\033[32m" << setw(3) << head_name[17].name << setw(1) << " ";
	cout << right << "\033[32m" << setw(3) << head_name[18].name << setw(1) << "|";

	//thread
	cout << right << "\033[32m" << setw(4) << head_name[19].name << setw(1) << " ";
	cout << right << "\033[32m" << setw(3) << head_name[20].name << setw(1) << "|";
...
void obtain_sys_cpu(point_list *pl,Cpu_info *cf,Cpu_info *old_cf)
{
	...
	else
	{
		...
		pl[21].point_dic->cpu_data = double(cf->user - old_cf->user)/double(total_time)*100;
		pl[22].point_dic->cpu_data = double(cf->system - old_cf->system)/double(total_time)*100;
		pl[23].point_dic->cpu_data = double(cf->idle - old_cf->idle)/double(total_time)*100;
		pl[24].point_dic->cpu_data = double(cf->iowait - old_cf->iowait)/double(total_time)*100;
		pl[25].point_dic->cpu_data = double(cf->softirq - old_cf->softirq)/double(total_time)*100;	
	    pl[26].point_dic->current_data = cf->ctxt - old_cf->ctxt;
